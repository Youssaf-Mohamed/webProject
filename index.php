...
<body class="img js-fullheight" style="height:100vh; background-image: url(images/d.jpg);">
    <section class="ftco-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <!--<span class="title" style="color:#fff">O c e a n</span>-->
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        <h2 class="mb-20 text-center" style="color: #fff;">Have an Account?</h2>
                        ...
                        <div class="alert alert-warning" role="alert">
                            <strong>No User</strong> <br> Please Enter Valid Email and Password or <a
                                href="register.php">Sing Up</a> !
                        </div>
                        <?php
                        }
                        ?>
        ...
        <div style="text-align: center;" class="mt-2"> <a style="color: #fff;" href="register.php">Register Now !</a>
        </div>
    </section>
